...
REQUIRED_SCOPE = os.environ.get("IAS_REQUIRED_SCOPE", "api_read_access")


class AuthMiddleware(BaseHTTPMiddleware):
    """Validates JWT tokens from SAP IAS and enforces a required scope."""
    ...
    def verify_token(self, token: str):
        ...
        if REQUIRED_SCOPE not in payload.get("ias_apis", []):
...
IASAuthMiddleware = AuthMiddleware
